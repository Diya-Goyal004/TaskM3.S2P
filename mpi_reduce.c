...
int main(int argc, char* argv[]) {
  ...
  // Calculate local sum of local_v3
  ...
  // Use MPI_Reduce to sum the local sums into the total sum
  ...
  if (rank == 0) {  // Master process
    ...
    cout << "Total sum of all elements in v3: " << total_sum << endl;  // Output the total sum
  }
